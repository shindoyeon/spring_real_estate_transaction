...
// location.href=queryParams;
  ...
  //fetch(`http://localhost:80/happyhouse/api?dong=${dongCode}&DEAL_YMD=${dealYM}&aptName=${aptName}`)
  fetch(`http://localhost:80/happyhouse/house/search?dongCode=${dongCode}&apartmentName=${aptName}`)
