...
document.querySelector("#list-btn").addEventListener("click", function () {
  ...
  let queryParams = "/happyhouse-db-15/api?"
...
// location.href=queryParams;
  ...
  //fetch(`http://localhost:8080/happyhouse-db-15/api?dong=${dongCode}&DEAL_YMD=${dealYM}&aptName=${aptName}`)
  fetch(`http://localhost:8080/happyhouse-db-15/apartment?act=search&dong=${dongCode}&DEAL_YMD=${dealYM}&aptName=${aptName}`)
